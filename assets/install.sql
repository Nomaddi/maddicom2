...
CREATE TABLE `beauty_service` (
  ...
  `service_times` longtext DEFAULT NULL,
...
CREATE TABLE `blogs` (
  ...
  `blog_text` longtext DEFAULT NULL,
...
CREATE TABLE `blog_comments` (
  ...
  `user_id` int(11) DEFAULT NULL,
  `under_comment_id` varchar(255) DEFAULT '0' COMMENT '0 == main comment, 0 != under comment',
  `added_date` varchar(255) DEFAULT NULL,
  `modified_date` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
('evrl21av5tj7b4a5g79gt50tvkjpebts', '::1', 1728214740, );
...
CREATE TABLE `listing` (
  ...
  `listing_thumbnail` varchar(255) DEFAULT NULL,
  `listing_cover` varchar(255) DEFAULT NULL,
  `seo_meta_tags` longtext DEFAULT NULL,
  `meta_description` longtext DEFAULT NULL,
  `date_added` varchar(255) DEFAULT NULL,
  `date_modified` int(11) DEFAULT NULL,
  `is_featured` int(11) NOT NULL DEFAULT 0,
  `google_analytics_id` varchar(255) DEFAULT NULL,
  `package_expiry_date` varchar(100) DEFAULT NULL,
  `state_id` int(11) DEFAULT NULL,
  `price_range` varchar(100) DEFAULT 'no',
  `opened_minutes` varchar(100) DEFAULT 'no',
  `closed_minutes` varchar(100) DEFAULT 'no'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(14, 'paypal', '[{\"active\":\"1\",\"mode\":\"sandbox\",\"sandbox_client_id\":\"",\"production_client_id\":\"12345\",\"sandbox_secret_key\":\"",\"production_secret_key\":\""}]'),
(15, 'stripe', '[{\"active\":\"1\",\"testmode\":\"on\",\"public_key\":\"",\"secret_key\":\"",\"public_live_key\":\"",\"secret_live_key\":\""}]'),
...
(47, 'recaptcha_sitekey', 'recaptcha-site-key'),
(48, 'recaptcha_secretkey', 'recaptcha-secret-key'),
(49, 'meta_pixel', '0');
