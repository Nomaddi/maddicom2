  ...
  <div class="col-sm-7">
    <select class="form-control select2" name="user_id" id = "user_id" required>
      ...
      <?php foreach ($all_users as $all_user): ?>
        <option value="<?php echo $all_user['id']; ?>" <?php if($all_user['id'] == $listing_details['user_id'])echo 'selected'; ?>><?php echo $all_user['name']; ?> <span style="font-size: 12px;">(<?php echo $all_user['email']; ?>)</span></option>
      <?php endforeach; ?>
    </select>
  </div>
</div>
                        ...
                        <?php foreach ($categories as $category): 
                          $sub_categories = $this->crud_model->get_sub_categories($category['id'])->result_array();?>
                            ...
                            <?php foreach ($sub_categories as $sub_category): ?>
                                <option value="<?php echo $sub_category['id']; ?>" <?php if ($sub_category['id'] == $listing_category): ?> selected <?php endif; ?>>&nbsp;&nbsp; - <?php echo $sub_category['name']; ?></option>
                            <?php endforeach; ?>
                        <?php endforeach; ?>
                    </select>
                </div>
...
<div class="form-group">
  ...
  <div class="col-sm-7">
    <select name="country_id" id = "country_id" class="select2" data-allow-clear="true" data-placeholder="<?php echo get_phrase('select_country'); ?>" onchange="countryWiseStateOnCreate(this.value)">
...
<div class="form-group ">
						...
						<?php foreach ($states as $state): ?>
							<option value="<?php echo $state['id']; ?>" <?php if($listing_details['state_id'] == $state['id']) echo 'selected'; ?>><?php echo $state['name']; ?></option>
							<?php endforeach; ?>
						</select>
						</div>
...
<div class="form-group">
  ...
  <div class="col-sm-7">
    <input type="text" class="form-control" id="latitude" value="<?php echo $listing_details['latitude']; ?>" name="latitude">
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-sm-7">
    <input type="text" class="form-control" id="longitude" value="<?php echo $listing_details['longitude']; ?>" name="longitude">
  </div>
</div>
