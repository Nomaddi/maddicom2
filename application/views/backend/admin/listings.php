  ...
  <div class="col-lg-12">
    <form method="POST" class="col-md-12 ajaxForm" action="<?php echo site_url('admin/import_excel'); ?>" id="import_listing" enctype="multipart/form-data">
      ...
      <div class="text-center">
        <button type="submit" class="btn btn-primary alignToTitle col-md-4 col-sm-12 mb-4 mt-3"><?php echo get_phrase('Import listing'); ?></button>
      </div>
    </form>
              ...
              <div class="form-group">
                <div class="col-sm-12">
                  <select name="verify_status" id="verify_status" class="select2 form-control" data-allow-clear="true" data-placeholder="<?php echo get_phrase('verification_status'); ?>">
                    ...
                    <option value="1" <?php if (isset($verify_status)) {
                                        if ($verify_status == '1') echo 'selected';
                                      } ?>><?php echo get_phrase('verified'); ?></option>
                    <option value="0" <?php if (isset($verify_status)) {
                                        if ($verify_status == '0') echo 'selected';
                                      } ?>><?php echo get_phrase('non_verified'); ?></option>
                  </select>
                </div>
              </div>
            </div>
        ...
        <table class="table table-bordered datatable">
          <thead>
            <tr>
              ...
              <th>
                <div><?php echo get_phrase('categories'); ?></div>
              </th>
              <th>
              ...
              <th>
                <div><?php echo get_phrase('option'); ?></div>
              </th>
            </tr>
          </thead>
